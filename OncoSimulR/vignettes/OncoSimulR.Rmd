...
## Recovering normal functionality of plot.oncosimul for plotting legend 
rm (plot.oncosimul, myhsvcols, plot.stacked2, plotClonesSt, xlim.pop.data)
```
